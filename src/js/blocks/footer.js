...
export default function Footer() {
    ...
    const { LAST_LOGIN_DATE, LAST_IP_ADDRESS, INSTANCE, VERSION, REVISION, DEBUG, BUILD_TIME, DBNAME } = useAuthContext();
    ...
    return (
        <footer className="mt-4 mb-2">
            ...
            <Row className="mr-0 d-print-none">
            ...
            <Row className="mr-0 mt-1">
                <Col className="d-flex justify-content-center font-size-85"><small>Build Time: {BUILD_TIME}</small></Col>
            </Row>
            {DEBUG &&
                <Row className="mr-0">
                    <Col className="d-flex justify-content-center font-size-85"><small>Database: {DBNAME}</small></Col>
                </Row>
            }
