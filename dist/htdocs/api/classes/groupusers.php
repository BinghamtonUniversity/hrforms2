...
class GroupUsers extends HRForms2 {
     ...
     */
    function validate() {
        if (!isset($this->req[0])) $this->raiseError(E_BAD_REQUEST,array("errMsg"=>"Group ID not specified"));
        if ($this->method=='PUT' && !$this->sessionData['isAdmin']) $this->raiseError(E_FORBIDDEN,array("errMsg"=>"You do not have permission to modify group users."));
    }
